...
- (BOOL)hidesSharedBackground  {
    if (@available(iOS 26.0, *)) {
        ...
        return [super hidesSharedBackground];
    }
}
@end
@interface ZLToolBar()
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        for (NSNumber *positionNumber in positions) {
            UIBarPosition position = positionNumber.integerValue;
...
- (ZLBarButtonItem *)previousBarButton {
    if (!_previousBarButton) {
        ...
        _previousBarButton.tintColor = UIColor.systemBlueColor;
...
- (ZLBarButtonItem *)nextBarButton {
    if (!_nextBarButton) {
        ...
        _nextBarButton.tintColor = UIColor.systemBlueColor;
    }
...
- (ZLBarButtonItem *)doneBarButton {
    if (!_doneBarButton) {
        ...
        _doneBarButton.tintColor = UIColor.systemBlueColor;
    }
